...
export default function Home() {
  return (
    <>
      <StructuredData />
      <div className="flex min-h-screen flex-col mt-0">
        <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 container px-4 ">
            <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
              ...
              {/* Logo centralizada */}
              <Image
                src="/logos/logo-horizontal.png" // caminho da sua logo
                alt="Logo Psicóloga Kalynna Moreira"
                width={200} // ajuste conforme necessário
                height={200}
                className="mb-8 mt-[-60px]"
                priority
              />
        ...
        <section id="contact" className="py-2 bg-[#FDE2E4]" aria-labelledby="contact-heading">
